...
public class DataGenerator {
    ...
    public static String generateCity(String locale) {
        String[] city = {"Абакан", "Анадырь", "Архангельск", "Астрахань",
                ...
                "Гатчина", "Горно-Алтайск", "Грозный",
                "Екатеринбург",
                "Иваново", "Ижевск", "Иркутск",
                "Йошкар-Ола",
                "Казань", "Калининград", "Калуга", "Кемерово", "Киров", "Кострома", "Красногорск", "Краснодар", "Красноярск", "Курган", "Курск", "Кызыл",
                "Липецк",
